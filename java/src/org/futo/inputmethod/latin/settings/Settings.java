    ...
    implements SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    public static final String PREF_CUSTOM_KEYPRESS_PROFILE =
        "pref_custom_keypress_profile";
...
*/
    ...
    public static final String PREF_EDIT_PERSONAL_DICTIONARY =
        "edit_personal_dictionary";
    public static final String PREF_CONFIGURE_DICTIONARIES_KEY =
        "configure_dictionaries_key";
    // PREF_AUTO_CORRECTION_THRESHOLD_OBSOLETE is obsolete. Use PREF_AUTO_CORRECTION instead.
    public static final String PREF_AUTO_CORRECTION_THRESHOLD_OBSOLETE =
        "auto_correction_threshold";
    public static final String PREF_AUTO_CORRECTION =
        "pref_key_auto_correction";
    // PREF_SHOW_SUGGESTIONS_SETTING_OBSOLETE is obsolete. Use PREF_SHOW_SUGGESTIONS instead.
    public static final String PREF_SHOW_SUGGESTIONS_SETTING_OBSOLETE =
        "show_suggestions_setting";
    public static final String PREF_SHOW_SUGGESTIONS = "show_suggestions";
    public static final String PREF_KEY_USE_CONTACTS_DICT =
        "pref_key_use_contacts_dict";
    public static final String PREF_KEY_USE_PERSONALIZED_DICTS =
        "pref_key_use_personalized_dicts";
    public static final String PREF_KEY_USE_TRANSFORMER_LM =
    ...
    public static final String PREF_ENABLE_SPLIT_KEYBOARD =
        "pref_split_keyboard";
    ...
    public static final String PREF_KEY_LONGPRESS_TIMEOUT =
    ...
    public static final String PREF_GESTURE_PREVIEW_TRAIL =
        "pref_gesture_preview_trail";
    public static final String PREF_GESTURE_FLOATING_PREVIEW_TEXT =
        "pref_gesture_floating_preview_text";
    public static final String PREF_SHOW_SETUP_WIZARD_ICON =
        "pref_show_setup_wizard_icon";

    public static final String PREF_KEY_IS_INTERNAL = "pref_key_is_internal";

    public static final String PREF_ENABLE_METRICS_LOGGING =
        "pref_enable_metrics_logging";

    public static final String PREF_SHOW_ACTION_KEY = "pref_show_emoji_key";
    public static final String PREF_ACTION_KEY_ID = "pref_action_key_strid";

    public static final String PREF_ENABLE_NUMBER_ROW =
        "pref_enable_number_row";
    public static final String PREF_ENABLE_ARROW_ROW = "pref_enable_arrow_row";
    public static final String PREF_ENABLE_ALT_PERIOD_KEY =
        "pref_enable_alt_period_key";
    public static final String PREF_USE_DICT_KEY_BOOSTING =
        "pref_use_dict_key_boosting";
    ...
    public static final String PREF_USE_WESTERN_NUMERALS =
        "pref_use_western_numerals";

    public static final int DEFAULT_ALT_SPACES_MODE = SPACES_MODE_ALL;

    // Emoji
    public static final String PREF_EMOJI_RECENT_KEYS = "emoji_recent_keys";
    public static final String PREF_EMOJI_CATEGORY_LAST_TYPED_ID =
        "emoji_category_last_typed_id";
    public static final String PREF_LAST_SHOWN_EMOJI_CATEGORY_ID =
    ...
    public HashSet<SettingsChangedListener> settingsChangedListeners =
        new HashSet<>();
    ...
    public void onSharedPreferenceChanged(
        ...
        try {
            ...
            loadSettings(
                mContext,
                mSettingsValues.mLocale,
                mSettingsValues.mInputAttributes
            );
        } finally {
    ...
    public static boolean readVibrationEnabled(
        final SharedPreferences prefs,
        final Resources res
    ) {
    ...
    public static boolean readAutoCorrectEnabled(
        final SharedPreferences prefs,
        final Resources res
    ) {
    ...
    public static boolean readFromBuildConfigIfGestureInputEnabled(
        final Resources res
    ) {
    ...
    public static boolean readGestureInputEnabled(
        final SharedPreferences prefs,
        final Resources res
    ) {
        return (
    ...
    public static boolean readFromBuildConfigIfToShowKeyPreviewPopupOption(
        final Resources res
    ) {
        return res.getBoolean(
            R.bool.config_enable_show_key_preview_popup_option
        );
    }
    ...
    public static int readKeyPreviewPopupDismissDelay(
        final SharedPreferences prefs,
        final Resources res
    ) {
    ...
    public static String readPrefAdditionalSubtypes(
        final SharedPreferences prefs,
        final Resources res
    ) {
        final String predefinedPrefSubtypes =
            AdditionalSubtypeUtils.createPrefSubtypes(
                res.getStringArray(R.array.predefined_subtypes)
            );
        return prefs.getString(
            PREF_CUSTOM_INPUT_STYLES,
            predefinedPrefSubtypes
        );
    }

    public static void writePrefAdditionalSubtypes(
        final SharedPreferences prefs,
    ...
    public static float readKeypressSoundVolume(
        final SharedPreferences prefs,
        final Resources res
    ) {
        final float volume = prefs.getFloat(
            PREF_KEYPRESS_SOUND_VOLUME,
            UNDEFINED_PREFERENCE_VALUE_FLOAT
        );
    ...
    private static final String DEFAULT_KEYPRESS_SOUND_VOLUME = Float.toString(
        -1.0f
    );
    ...
    public static int readKeyLongpressTimeout(
        final SharedPreferences prefs,
        final Resources res
    ) {
    ...
    public static int readDefaultKeypressVibrationDuration(
        final Resources res
    ) {
        return Integer.parseInt(
            ResourceUtils.getDeviceOverrideValue(
    ...
    public static float readKeyPreviewAnimationScale(
        ...
        final float fraction = prefs.getFloat(
            prefKey,
            UNDEFINED_PREFERENCE_VALUE_FLOAT
        );
        return (fraction != UNDEFINED_PREFERENCE_VALUE_FLOAT)
            ? fraction
            : defaultValue;
    }
    ...
    public static float readKeyboardHeight(
        final SharedPreferences prefs,
        final float defaultValue
    ) {
        ...
        return (percentage != UNDEFINED_PREFERENCE_VALUE_FLOAT)
            ? percentage
            : defaultValue;
    }
    ...
    public static boolean readShowSetupWizardIcon(
        final SharedPreferences prefs,
        final Context context
    ) {
    ...
    public void writeLastUsedPersonalizationToken(byte[] token) {
        if (token == null) {
            ...
            mPrefs
                .edit()
                .putString(PREF_LAST_USED_PERSONALIZATION_TOKEN, tokenStr)
                .apply();
        }
    }

    public byte[] readLastUsedPersonalizationToken() {
        final String tokenStr = mPrefs.getString(
            PREF_LAST_USED_PERSONALIZATION_TOKEN,
            null
        );
    ...
    public void writeLastPersonalizationDictWipedTime(final long timestamp) {
        mPrefs
            .edit()
            .putLong(PREF_LAST_PERSONALIZATION_DICT_WIPED_TIME, timestamp)
            .apply();
    }
    ...
    public void writeCorpusHandlesForPersonalization(
        final Set<String> corpusHandles
    ) {
        mPrefs
            .edit()
            .putStringSet(
    ...
    public Set<String> readCorpusHandlesForPersonalization() {
        ...
        return mPrefs.getStringSet(
            PREF_CORPUS_HANDLES_FOR_PERSONALIZATION,
            emptySet
        );
    }

    public static void writeEmojiRecentKeys(
        final SharedPreferences prefs,
        String str
    ) {
    ...
    public static void writeLastShownEmojiCategoryId(
        ...
        prefs
            .edit()
            .putInt(PREF_LAST_SHOWN_EMOJI_CATEGORY_ID, categoryId)
            .apply();
    }
    ...
    private void upgradeAutocorrectionSettings(
        final SharedPreferences prefs,
        final Resources res
    ) {
        final String thresholdSetting = prefs.getString(
        ...
        if (thresholdSetting != null) {
            ...
            editor.putBoolean(
                ...
                !thresholdSetting.equals(autoCorrectionOff)
            );
            editor.commit();
        }
    }
